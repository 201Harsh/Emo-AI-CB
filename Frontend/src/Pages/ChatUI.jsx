  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col relative z-10 h-full">
        ...
        <div className="flex-1 overflow-y-auto p-3 md:p-4 space-y-4 pt-20 pb-24 md:pb-28 scrollbar-thin scrollbar-thumb-yellow-600/50 scrollbar-track-transparent chat-box">
          {messages.length === 0 && (
